...
;var SSN_COOKIE_NAME = "glance_ssn_info", GLANCEVERSION3 = ["5", "8", "5", "0"].slice(0, 3).join("."), GLANCESCRIPTVERSION = GLANCEVERSION3 + "" + (GLANCE.MINIMIZED ? "M" : "");
...
function initAPI(a) {
  GLANCE.Cobrowse.VisitorUI.VERSION = "5.8.5.0";
